...
parser = argparse.ArgumentParser(description="Sender - Gửi ảnh Male/Female qua socket")
parser.add_argument('--folder_path', '-f', required=True, type=str, help='Thư mục chứa ảnh Male và Female')
